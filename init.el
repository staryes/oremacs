...
;(let ((personal-emacs-git (expand-file-name "personal/git/" emacs-d)))
;  (mapc (lambda (x)
;          (add-to-list 'load-path (expand-file-name x personal-emacs-git)))
;        (delete "." (delete ".." (directory-files personal-emacs-git)))))
